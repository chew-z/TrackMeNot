...
TRACKMENOT.TMNSearch = function() {
    ...
    var feedList = "http://www.todayonline.com/feed/singapore~http://www.straitstimes.com/news/singapore/rss.xml~http://stackoverflow.com/feeds/tag/android+or+html+or+javascript+or+python~https://news.ycombinator.com/rss~https://trends.google.com/trends/hottrends/atom/feed?pn=p5";
    var tmnLogs = [];
    ...
    var skipex = [/mins ago/, /days ago/, /hours ago/, /1 day ago/, /1 hour ago/,
    ...
    var SearchBox_google = "var searchbox = function( ) { return getElementsByAttrValue(document,'input', 'name', 'q' ); } "
    var SearchBox_yahoo = "var searchbox = function(  ) { return document.getElementById('yschsp');}"
    var SearchBox_bing = "var searchbox = function(  ) {return document.getElementById('sb_form_q'); } "
    var SearchBox_aol = "var searchbox = function(  ) {return document.getElementById('csbquery1');  }"
    var SearchBox_baidu = "var searchbox = function(  ) {return document.getElementById('kw');}"
